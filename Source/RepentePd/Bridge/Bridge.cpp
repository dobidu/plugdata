...
bool Bridge::send(juce::String const& prompt, bool analyzeOnly, std::function<void(bool)> onDone)
{
    ...
    return client.send(prompt, context, [this, analyzeOnly, onDone](juce::String const& response) {
        ...
        if (analyzeOnly) {
            if (editor && editor->pd) {
                editor->pd->logRepente(String::fromUTF8("\xe2\x94\x80\xe2\x94\x80 analysis \xe2\x94\x80\xe2\x94\x80\xe2\x94\x80\xe2\x94\x80\xe2\x94\x80\xe2\x94\x80\xe2\x94\x80\xe2\x94\x80\xe2\x94\x80\xe2\x94\x80\xe2\x94\x80\xe2\x94\x80\xe2\x94\x80\xe2\x94\x80\xe2\x94\x80\xe2\x94\x80\xe2\x94\x80\xe2\x94\x80"));
                editor->pd->logRepente(response);
                editor->pd->logRepente(String::fromUTF8(""));
            }
